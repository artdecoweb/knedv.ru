  ...
  async componentDidMount() {
    ...
    try {
      ...
      if (error) this.setState({ error })
        ...
        const [d] = data
        this.setState({ data: d, hint: d.seo, catSeo: d.categorySeo })
      }
    } catch ({ message: error }) {
      this.setState({ error })
    } finally {
  ...
  render() {
    ...
    return <Col>
      ...
      <form
        ...
        <FormRow name="image" label="Изображение" help="Картинка, отображаемая на сайте." file="1" type="file" required="1"/>
